...
use pocketmine\Bluplayz\BWRefreshSigns;
...
class Bedwars extends PluginBase implements Listener {
    ...
    public function onEnable(){
        ...
        $this->getLogger()->info($this->prefix.TextFormat::GREEN."Plugin was successfully activated!");
    ...
    public function addPlayerToArena($arena, $name){
        ...
        $config->save();
        //$this->getLogger()->info("Player: ".$name." , has been in arena -> ".$arena." cleverly");
    }
            ...
            if($this->inArena($player)){
                ...
                if($this->getArenaStatus($arena) == "Lobby") {
                    if($team != $this->getTeam($player->getNameTag())){
                        ...
                        $player->sendMessage($this->prefix . "You are already in team " . TextFormat::GOLD . $team);
                        $player->getInventory()->removeItem($item);
                        $player->getInventory()->addItem($item);
                    }
                }
            ...
            if ($event instanceof EntityDamageByEntityEvent) {
                ...
                if($damager instanceof Player) {
                    if($this->inArena($damager)) {
                        $event->setCancelled();
                        $this->isShopping[$damager->getName()] = "Yes";
    ...
    public function onInteract(PlayerInteractEvent $event){
        ...
        if($this->registerBed == true && $this->registerBedWHO == $name){
            ...
            $player->sendMessage(TextFormat::GREEN . "You have successfully the bed of team " . TextFormat::AQUA . $team . TextFormat::GREEN . " for the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " registered!");
        ...
        if($tile instanceof Sign){
            ...
            if($this->registerSign == true && $this->registerSignWHO == $name){
                ...
                $player->sendMessage(TextFormat::GREEN . "You have successfully the shield for the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " registered!");
                $player->sendMessage(TextFormat::GREEN . "Setup -> /bw help");
            }
            elseif($text[0] == $this->prefix){

                if($text[2] == TextFormat::GREEN."To enter"){
                    ...
                    if($status == "Lobby"){
                        if($players < $maxplayers) {
                            ...
                            $player->sendMessage($this->prefix . TextFormat::RED . "You can not join this match!");
                        }
                    } else {
                        $player->sendMessage($this->prefix.TextFormat::RED."You can not join this match!");
                    }
        ...
        if($cmd->getName() == "Bedwars" && $sender->isOP()){
            if(!empty($args[0])){
                if(strtolower($args[0]) == "help" && $sender->isOP()){
                    ...
                    $sender->sendMessage(TextFormat::GRAY."-> ".TextFormat::DARK_AQUA."/bw regsign <Arena> ".TextFormat::GRAY."[".TextFormat::RED."Join an arena sign".TextFormat::GRAY."]");
                    $sender->sendMessage(TextFormat::GRAY."-> ".TextFormat::DARK_AQUA."/bw savemaps <Arena> ".TextFormat::GRAY."[".TextFormat::RED."Secure all worlds of an arena".TextFormat::GRAY."]");
                    $sender->sendMessage(TextFormat::GRAY."-> ".TextFormat::DARK_AQUA."/bw addarena <ArenaName> <Teams> <PlayerProTeam> ".TextFormat::GRAY."[".TextFormat::RED."Adds a new arena".TextFormat::GRAY."]");
                    $sender->sendMessage(TextFormat::GRAY."-> ".TextFormat::DARK_AQUA."/bw setlobby <Arena>".TextFormat::GRAY."[".TextFormat::RED."sets the arena lobby".TextFormat::GRAY."]");
                    $sender->sendMessage(TextFormat::GRAY."-> ".TextFormat::DARK_AQUA."/bw setspawn <Arena> <Team>".TextFormat::GRAY."[".TextFormat::RED."
sets the team spawns".TextFormat::GRAY."]");
                ...
                elseif(strtolower($args[0]) == "savemaps" && $sender->isOP()){
                    if(!empty($args[1])) {
                        ...
                        if($this->arenaExists($arena)) {
                            $this->saveMaps($arena);
                            $sender->sendMessage(TextFormat::GREEN . "You have successfully completed the maps of the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " secured!");
                        } else {
                            $sender->sendMessage(TextFormat::RED."Arena does not exist!");
                        }
                    } else {
                ...
                elseif(strtolower($args[0]) == "addarena" && $sender->isOP()){
                    if(!empty($args[1]) && !empty($args[2]) && !empty($args[3])) {
                        ...
                        if($teams <= 8){
                            ...
                            $this->arena = $arena;
                            $sender->sendMessage(TextFormat::GREEN . "You are successful in the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " created!");
                ...
                elseif(strtolower($args[0]) == "setlobby" && $sender->isOP()){
                    if(!empty($args[1])) {
                        ...
                        if($this->arenaExists($arena)) {
                            ...
                            $sender->sendMessage(TextFormat::GREEN . "You have successfully completed the lobby for the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " set!");
                            $sender->sendMessage(TextFormat::GREEN . "Setup -> /bw help");
                    ...
                    if(!empty($args[1]) && !empty($args[2])) {
                        ...
                        if($this->arenaExists($arena)) {
                            if (in_array($team, $this->getAllTeams())) {
                                ...
                                $sender->sendMessage(TextFormat::GREEN . "Now tap a bed! please tap the lower half because it can come to bugs otherwise!");
                    ...
                    if(!empty($args[1]) && !empty($args[2])) {
                        ...
                        if($this->arenaExists($arena)) {
                            if (in_array($team, $this->getAllTeams())) {
                                ...
                                $sender->sendMessage(TextFormat::GREEN . "You have successfully spawned the team ".TextFormat::AQUA . $team . TextFormat::GREEN." for the arena " . TextFormat::AQUA . $arena . TextFormat::GREEN . " set!");
                                $sender->sendMessage(TextFormat::GREEN . "Setup -> /bw help");
